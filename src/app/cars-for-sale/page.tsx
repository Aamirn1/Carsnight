...
import { Car, ChevronLeft, ChevronRight, Search, SearchX, SlidersHorizontal } from "lucide-react";
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://carsnight1.vercel.app/" },
      {
        ...
        position: 2,
        name: "Buy",
        item: "https://carsnight1.vercel.app/cars-for-sale",
      },
    ],
  };
        ...
        <div className="mb-6">
          ...
          >
            ...
            <input
              type="text"
              name="q"
              placeholder="Search by make, model, or keyword (e.g. Tesla, Porsche, Corolla)..."
