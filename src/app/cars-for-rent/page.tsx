...
export const metadata: Metadata = {
  title: "Cars for Rent — Rent Luxury & Sport Cars Worldwide",
  description:
...
const BASE_PATH = "/cars-for-rent";
const CATEGORY: "SALE" | "RENT" = "RENT";
const PRICE_MIN = 0;
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Cars for Rent</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6 lg:gap-8">
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-20 rounded-2xl border bg-card p-5 shadow-sm">
              <ListingFilters category="RENT" priceMin={PRICE_MIN} priceMax={PRICE_MAX} />
            </div>
          </aside>
          ...
          <div className="min-w-0">
            <div className="mb-4 flex items-center justify-between gap-2">
              <p className="text-sm text-muted-foreground">
                <strong className="text-foreground">{total.toLocaleString()}</strong> rentals
                {currentPage > 1 && (
                  <span>
                    {" "}
            ...
            {listings.length === 0 ? (
              <div className="rounded-2xl border bg-card p-10 sm:p-14 text-center">
                ...
                <h2 className="mt-4 text-lg font-semibold">No rentals found</h2>
